      ...
      <Container className="product-heading">
        ...
        <Row className="header2">
          ...
          >
            <strong>
              Your{" "}
              {state.purchaseType === "buy" ? "purchase" : state.purchaseType}{" "}
              will come in 2-4 days.
            </strong>
          </Col>
        </Row>
              ...
              <Col md={6}>
                <Card border="secondary" className="product-page-card">
                  <Card.Img
                    variant="top"
                    className="img"
                    src={state.checkoutProduct.thumbnail}
                  />
                </Card>
              </Col>
              <Col md={6}>
                ...
                <p className="info-price">
                  <span>
                    <strong>
                      1 | {state.checkoutProductColor} |{" "}
                      {state.checkoutProductSize}
                    </strong>
                  </span>
                </p>
              </Col>
      ...
      <Container className="total">
        ...
        <Row className="total-price">
          ...
          >
            <strong>
              $
              {state.purchaseType === "buy"
                ? `${state.checkoutProduct.price}`
                : `${(0.25 * state.checkoutProduct.price).toFixed(2)}`}
            </strong>
          </Col>
        </Row>
      </Container>
